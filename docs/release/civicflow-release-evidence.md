...
**Phase 5 documentation package; independently accepted and published to the
...
| ----------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| Branch                        | `main`                                                                                                                      |
| Source commit                 | `0632c5d503a98b9d37e2450f2e9c1f3265698930` (accepted application behavior)                                                  |
...
| Result                        | Current Site carries a documentation-only Phase 5 publication; application behavior remains the accepted version 10 runtime |

This identity describes the accepted application behavior. Hosted application
claims remain grounded in the version 10 checks recorded in the Phase 4 ledger;
the current Site also carries the Phase 5 documentation and license package.
...
| Candidate changes   | Documentation-only, committed and published through the Sites-managed source, limited to the Phase 5 allowlist |
| Deployment identity | Current documentation-only Sites publication, environment revision `2`, same public URL                        |
...
Final candidate status is clean `main`; the seven allowlisted artifacts are
...
the current documentation-only publication. Do not record an
