...
The Phase 5 release documents were committed and published as a
documentation-only Sites update. They do not change the application behavior
represented by the accepted version 10 identity above. Local test evidence and
hosted evidence remain separate below.
